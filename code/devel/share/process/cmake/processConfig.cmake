...
if("TRUE" STREQUAL "TRUE")
  set(process_SOURCE_PREFIX /home/jrkjamie/document/dataset/code/src/process)
  set(process_DEVEL_PREFIX /home/jrkjamie/document/dataset/code/devel)
  set(process_INSTALL_PREFIX "")
  set(process_PREFIX ${process_DEVEL_PREFIX})
else()
  set(process_SOURCE_PREFIX "")
  set(process_DEVEL_PREFIX "")
  set(process_INSTALL_PREFIX /home/jrkjamie/document/dataset/code/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'jrkjamie <jrkjamie@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'process' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'process' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jrkjamie/document/dataset/code/src/process/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT process_NUM_DUMMY_TARGETS)
      set(process_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::process::wrapped-linker-option${process_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR process_NUM_DUMMY_TARGETS "${process_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::process::wrapped-linker-option${process_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND process_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/jrkjamie/document/dataset/code/devel/lib;/home/jrkjamie/document/dataset/code/devel/lib;/home/jrkjamie/document/camera/pcd/devel/lib;/home/jrkjamie/rethink/devel/lib;/opt/ros/melodic/lib)
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${process_dep}_FOUND)
      find_package(${process_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${process_dep} REQUIRED NO_MODULE ${depend_list})
  endif()

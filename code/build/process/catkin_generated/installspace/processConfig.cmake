...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'process' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '\${prefix}/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/jrkjamie/document/dataset/code/install/lib;/home/jrkjamie/document/dataset/code/devel/lib;/home/jrkjamie/document/camera/pcd/devel/lib;/home/jrkjamie/rethink/devel/lib;/opt/ros/melodic/lib)
